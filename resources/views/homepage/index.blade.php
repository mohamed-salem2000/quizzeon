                ...
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown nav-item">
                        ...
                        <div class="dropdown-menu dropdown-with-icons">
                            ...
                            <a href="{{route('signup.index')}}" class="dropdown-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-default d-none d-lg-block" href="{{route('signup.index')}}"
                            onclick="scrollToDownload()">sign up
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-default d-none d-lg-block" href="{{route('indexinstructor')}}"
