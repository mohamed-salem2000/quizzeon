        ...
        <div class="card" style="width: 20rem;">
            ...
            <div class="card-body">
                ...
                <button type="button" rel="tooltip" class="btn btn-info btn-sm btn-icon" data-toggle="modal"
                    data-target="#exampleModal" onclick="getexamId('<?php echo e($exam->id); ?>')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <a id="examFormdestroy" href="<?php echo e(route('exam.show', [':exam'])); ?>">linke</a>
                    </div>
                </div>
            </div>
        </div>
...
function getexamId(examId, examname) {
    ...
    var linkUrl = "<?php echo e(route('exam.show', [':exam'])); ?>";
...
<?php echo $__env->make('dashboredinstructor.instructorlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Orange\Downloads\quizzeon\quizzeon\quizzeon\resources\views/dashboredinstructor/exam.blade.php ENDPATH**/ ?>