...
<body class="">
    ...
    -->
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li class="active ">
                        <a href="<?php echo e(route('instructodashboard')); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('exam.index')); ?>">
                            <i class="tim-icons icon-pin"></i>
                            <p>Exam</p>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('statistic.index')); ?>">
...
</html><?php /**PATH C:\Users\Orange\Downloads\quizzeon\quizzeon\quizzeon\resources\views/dashboredinstructor/instructorlayout.blade.php ENDPATH**/ ?>