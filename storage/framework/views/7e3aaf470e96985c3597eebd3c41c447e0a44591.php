        ...
        <div class="card" style="width: 20rem;">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-primary btn-fab btn-icon btn-round" data-toggle="modal"
                    ...
                    <i class="tim-icons icon-paper" onclick="getexamId('<?php echo e($exam->exam_name); ?>')"></i>
                </button>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputState" class="form-control" onchange="changeOptionType()">
                                    <option selected>single choice(radio button)</option>
                                    <option value="1">multiple choice</option>
                                    <option value="2">image choice</option>
                                    <option value="3">matching choice</option>
                                    <option value="4">fill the blank</option>
                                    <option value="5">upload file</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">exam description</label>
                                <input type="text" class="form-control" id="examId" placeholder="Password" disabled="">
                            </div>
                        </div>
...
function changeOptionType() {
    ...
    for (var i = 0; i < optionInputs.length; i++) {
        if (selectedOption === 'image choice') {
            optionInputs[i].setAttribute('type', 'file');
        } else {
            optionInputs[i].setAttribute('type', 'text');
        }
    }
}
</script>
...
<?php echo $__env->make('dashboredinstructor.instructorlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Orange\Desktop\MasteProject\quizzeon\resources\views/dashboredinstructor/exam.blade.php ENDPATH**/ ?>