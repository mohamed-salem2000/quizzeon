                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 offset-lg-0 offset-md-3">
                            ...
                            <div class="card card-register">
                                ...
                                <div class="card-body">
                                    <form class="form" action="<?php echo e(route('signup.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('homepage.homelayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Orange\Downloads\quizzeon\quizzeon\quizzeon\resources\views/homepage/register.blade.php ENDPATH**/ ?>